...
function App() {
  ...
  const { markets, polymarketEvents, loading, error, refresh, refreshPolymarket, apiUrl } = useMarkets();
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col px-6 pb-16 pt-8 lg:px-10">
        ...
        <section id="markets" className="mt-14">
          ...
          <div className="mt-6">
            <MarketsList markets={markets} polymarketEvents={polymarketEvents} loading={loading} error={error} />
          </div>
        </section>
